...
class controller:
    ...
    def remove_item(self,item):
        ...
        self.order.pop(self.order.index(self.ComboBox.currentText()))
        self.price_total -= all_class[self.ComboBox.currentIndex()]._price
        self.total_set()
    ...
    def set_all(self, current_class):
        ...
        self.item_price.setText(f"Price: ${str(current_class._price)}")
        self.total_set()
