...
#Allows for user to alter current day
allow_alter = False
debug = QSpinBox()
...
vc = controller(allow_alter,debug,catergories,ComboBox,item_name,item_price,item_vegan,item_vege,item_sugar,add_order,orders,total,submit_order)
vc.view_load()
